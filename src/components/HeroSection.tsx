        ...
        <div className="relative container mx-auto px-4 text-white">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-ochre/20 border border-ochre/40 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-ochre text-sm font-medium">Юг · Поволжье · Центральная Россия</span>
            </div>
            <h1 className="font-montserrat font-black text-4xl md:text-6xl leading-tight mb-4" style={{ textShadow: "0 2px 20px rgba(0,0,0,0.5)" }}>
              Производство<br />
              <span className="text-ochre text-6xl">металлоконструкций</span><br />
              полного цикла
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-montserrat font-black md:text-4xl text-graphite mb-6 leading-tight text-4xl">"САРМАТ" - ваш надежный партнер в производстве из металла</h2>
